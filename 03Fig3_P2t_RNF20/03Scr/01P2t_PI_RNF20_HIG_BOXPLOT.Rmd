---
title: "01P2t_PI_RNF20_HIG_BOXPLOT"
author:
...
PTHA11="../03OUTPUT/"
dir.create(PTHA11)
PROJECT="01P2t_PI_RNF20_HIG_BOXPLOT"
...
PEAK1="aCtr"
PEAK2="bR20"
c1 = "../01DATA/siCtrl_tag_countall_gene_PI.txt"
...
c2 = "../01DATA/siRNF20_tag_countall_gene_PI.txt"
...
NAME_SAMPLE<- c("actr","aR20")
colnames(mat_CTR22)<- c("SYMBOL","actr")
colnames(mat_R202)<- c("SYMBOL","aR20")
...
mat_CTR_20$zR20 = as.numeric(scale(mat_CTR_20$aR20,center = F))

mat_CTR_20$PI_R20_v_ctr<- mat_CTR_20$aR20/mat_CTR_20$actr
mat_CTR_20$log2PI_R20_v_ctr<- log2(mat_CTR_20$PI_R20_v_ctr)

mat_CTR_20$zlog2PI<-log2(mat_CTR_20$zR20/mat_CTR_20$zctr)

V45_se = read.delim("../01DATA/gencode.v45.basic_more1kb.txt",header=T,sep="\t",dec=".")
...
GN5e2<- subset(mat_CTR_20_m1u,select=c("SYMBOL","actr","aR20","zctr","zR20","PI_R20_v_ctr","log2PI_R20_v_ctr","zlog2PI"))
...
GN5e3b<- subset(GN5e2,CLU2=="01HIG" | CLU2=="02ME" | CLU2=="03LOW",select=c("SYMBOL",NAME_SAMPLE,"log2PI_R20_v_ctr", "CLU","CLU2"))
...
```{r,message=FALSE,class.source="bg-info",warning=FALSE,echo=T}
CO_ALU=c("black","#d7191c", "#542788","#d8b365","#abd9e9", "#2c7bb6", "#4d4d4d","#5ab4ac","grey","#de77ae")
